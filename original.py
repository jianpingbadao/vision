...
with open("results", 'w', newline='') as f:
        ...
        while(cap.isOpened()):
            ...
            if ret==True:
                    ...
                    if area>areaTH:
                        ...
                        if cy in range(up_limit,down_limit):
                            ...
                            if new==True: #If nothing is detected,create new
                                p=old_vehicles.Car(pid,cx,cy,max_p_age)
                                cars.append(p)
                                pid+=1
                ...
                str_up='UP: '+str(cnt_down)
                str_down='DOWN: '+str(cnt_up)
        ...
        writer.writerow((str_up, str_down, time.strftime("%c")))         
